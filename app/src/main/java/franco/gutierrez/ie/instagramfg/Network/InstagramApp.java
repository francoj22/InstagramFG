package franco.gutierrez.ie.instagramfg.Network;
...
import franco.gutierrez.ie.instagramfg.View.InstagramDialog;
...
public class InstagramApp {
    ...
    public InstagramApp(Context mcontext) {

    }

    public InstagramApp(Context mApplication_Context, Context context, String clientId, String clientSecret,
                        String callbackUrl) {

        mClientId = clientId;
        mClientSecret = clientSecret;
        mCtx = context;
        mSession = new InstagramSession(mApplication_Context);
